...
save_results = true;
if save_results
    savename = inputdlg('Enter filename to save data:', 'Save Filename');
    %savename = 's300_bgsubtracted_fixedNWsize_5nm'; %filenamebase
end


calculate = 'backgroundSubtracted'; %options: backgroundSubtracted, background, raw
show_figures = false;
numberrepeats = 20; %Even repeats for multiples of 6000 nm (ie [20 15 10 6] repeats for [300 400 600 1000])
...
%Select background field file
[backgroundFile, backgroundFilePath] = uigetfile('*.mat','Select the backgorund field file');
%backgroundFile = 'background_fields_300_200substrate_200top_20PML.mat';
%backgroundFile = 'background_fields_300_100top_res2.mat';
%backgroundFile = 'background_fields_300.mat';

%Select folder containing all the files
folderpath=uigetdir('','Select folder with field files');
%folderpath = 'F:\Michael\Stanford\Research\Data\Simulation\3D_nonuniform_xy_d_40_s_300_maxL_1000_res_10_200nmtop_20PML';
%folderpath = 'F:\Michael\Stanford\Research\Data\Simulation\testing\3D_nonuniform_xy_d_40_s_300_maxL_1000_res_10_100nmtop';
%folderpath = 'F:\Michael\Stanford\Research\Data\Simulation\testing\3D_nonuniform_xy_d_40_s_300_maxL_1000_res_10';
%folderpath = 'F:\Michael\Stanford\Research\Data\Simulation\testing\3D_nonuniform_xy_d_40_s_300_maxL_1000_res_10\test';
...
title('s=300 Source - Background Emission Subtracted - 10nm NW y grid','Interpreter','latex')
...
%Export
if save_results
    save(savename{1}, 'length_series', 'integ_series', 'src_array', 'obj_array', 'domainwidth', 'domaindepth', 'numberrepeats')
end